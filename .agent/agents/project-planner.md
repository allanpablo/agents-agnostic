...
1.  **Read** `CODEBASE.md` if present → Check platform/runtime notes
2.  **Read** any existing plan files in project root
3.  **Check** if request is clear enough to proceed
4.  **If unclear:** Ask 1-2 quick questions, then proceed

> 🔴 **Platform Rule:** Use platform-appropriate commands and paths.
> - Detect the active OS, shell, package manager, and runtime before prescribing commands.
> - Prefer platform-neutral planning language unless the environment is explicitly known.
...
| Step | Action | Command |
|------|--------|---------|
| 1 | Checklist | Rule compliance and scope verification |
| 2 | Scripts | `checklist.py` first, then targeted scripts if needed |
| 3 | Build | Use the project's actual build command |
| 4 | Run & Test | Use the project's actual dev/test commands and active local URL |
...
python .agent/skills/performance-profiling/scripts/lighthouse_audit.py <local-app-url>

# P4: Playwright E2E (requires running server)
python .agent/skills/webapp-testing/scripts/playwright_runner.py <local-app-url> --screenshot
```
