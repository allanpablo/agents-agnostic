...
> **Guide to creating and using skills in this agent kit**

---

## 📋 Overview

Base models are powerful generalists, but they do not know your specific project context or your team's standards. Loading every rule or tool into the agent's context window leads to "tool bloat," higher costs, latency, and confusion.

**Skills** solve this through **Progressive Disclosure**. A skill is a package of specialized knowledge that remains dormant until needed. This information is only loaded into the agent's context when your specific request matches the skill's description.
